pro sne_plot_lc2,name,w2cat=w2cat,m2cat=m2cat,w1cat=w1cat,uucat=uucat,bbcat=bbcat,vvcat=vvcat,save=save,ps=ps,xrange=xrange,yrange=yrange,xlog=xlog
plotsym,0,1,/fill
...
if(not keyword_set(lpsym)) then lpsym=8 else lpsym=[lpsym,8]
...
plotsym,0,1,/fill
ind=cont_ind[1:nv-1]
oplot,w2t[ind],w2m[ind],psym=8, linesty=0,thick=2+ps,color=!cyan
endif
...
plotsym,0,1,/fill
ind=cont_ind[1:nv-1] 
oplot,m2t[ind],m2m[ind],psym=8, linesty=0,thick=2+ps,color=!MAGENTA
endif
...
ind=cont_ind[1:nv-1]
plotsym,0,1,/fill
oplot,w1t[ind],w1m[ind],psym=8, linesty=0,thick=2+ps,color=!ORANGE
endif
...
plotsym,0,1,/fill
ind=cont_ind[1:nv-1]
oplot,uut[ind],uum[ind],psym=8, linesty=0,thick=2+ps,color=!RED
endif
...
ind=cont_ind[1:nv-1] 
plotsym,0,1,/fill
oplot,bbt[ind],bbm[ind],psym=8, linesty=0,thick=2.5+ps,color=!GREEN
endif
...
if(nv  ge 3) then begin
ind=cont_ind[1:nv-1]
plotsym,0,1,thick=2+ps,/fill
oplot,vvt[ind],vvm[ind],psym=8, linesty=0,thick=2+ps,color=!BLUE
endif

endwhile
plotsym,1,2.5,thick=2+ps,/fill
...
ind=cont_ind[1:nv-1]
plotsym,1,2.5,thick=2+ps
oplot,wht[ind],whm[ind],psym=8, linesty=0,thick=2+ps,color=!Forest
endif
